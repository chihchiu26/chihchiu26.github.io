...
document.getElementsByClassName('img_hover7')[0].onmouseover = function () {
    document.getElementsByClassName('nav_highlight7')[0].style = "color: #333333 ; text-decoration:underline"
}
document.getElementsByClassName('img_hover7')[0].onmouseout = function () {
    document.getElementsByClassName('nav_highlight7')[0].style = ""
}


document.getElementsByClassName('img_hover8')[0].onmouseover = function () {
    document.getElementsByClassName('nav_highlight8')[0].style = "color: #333333 ; text-decoration:underline"
}
